...
def create_base_parser(
    tool_name: str, description: str, version: str | None = None
...
def add_database_args(parser: argparse.ArgumentParser) -> None:
    ...
    db_group.add_argument("--username", default="root", help="ArangoDB username (default: root)")
...
def add_file_args(parser: argparse.ArgumentParser) -> None:
    ...
    file_group.add_argument("--output", "-o", type=Path, help="Output file path")
    ...
    file_group.add_argument("--overwrite", action="store_true", help="Overwrite existing files")
...
def print_tool_header(tool_name: str, version: str | None = None) -> None:
    """
